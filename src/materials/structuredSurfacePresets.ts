...
const ASPHALT_GRAPH = graph('designer-road-asphalt', 'Designer · Road Asphalt', [
  node('binder', 'noise', 'Bitumen Binder', 0, 0, {
    kind: 'base', channel: 'surface', colorA: '#151719', colorB: '#292c2d', roughness: 0.2
  }),
...
export const STRUCTURED_SURFACE_PRESETS: readonly MaterialPreset[] = [
  ...
  preset(ASPHALT_GRAPH, 'Dense asphalt aggregate embedded in dark binder with fine mineral roughness and subtle road dust.', ['asphalt', 'road', 'ground'], { roughness: 0.72, specularIntensity: 0.22 }, { variation: 0.38, stochasticTiling: 0.18 }),
