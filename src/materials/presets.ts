  ...
  },
  {
    ...
    layers: [
      ...
      layer('preset-marble-cloud', 'Mineral cloud', 'fbm', {
        blendMode: 'screen', opacity: 0.44, scale: 2.8, strength: 1.2, seed: 12,
        colorA: '#242a31', colorB: '#707986', displacement: 0.018
      }),
      layer('preset-marble-vein', 'White veins', 'veins', {
        blendMode: 'screen', opacity: 0.72, scale: 5.7, strength: 1.7, seed: 23,
        colorA: '#59616b', colorB: '#eef2f5', roughness: -0.12, displacement: 0.004
      })
    ]
  },
  {
  ...
  },
  {
    ...
    layers: [
      ...
      layer('preset-alien-cells', 'Cells', 'cellular', {
        ...
        colorA: '#1d3033', colorB: '#83aa91', displacement: 0.038
      }),
