...
function displacementSignalExtent(kind: LayerKind): number {
  ...
  if (kind === 'cellular') return cellularConfig.displacement.gain * 0.5;
  return 0.5;
}
...
export class MaterialCompiler {
  ...
  private configureSurfaceShader(): void {
    ...
    this.material.customProgramCacheKey = () => 'procedural-texture-lab-surface-v12';
  }
  ...
  private configureShadowShader(
    ...
    material.customProgramCacheKey = () => `procedural-texture-lab-${pass}-v7`;
  }
}
